...
/**
 * 
 *  Keeps track of all cell objects and their respective functions. It contains
 *  update methods that are called constantly in World class which update the 
 *  affected cells.
 *
 *  @author  Melissa Wei, Vikranth Srivatsa, Alex Minooka
 *  @version May 24, 2016
 *  @author  Period: 6
...
{
    /**
     * Holds all the red cell objects 
     */
    private static ArrayList<Cell> redValues;

    private static ArrayList<Cell> whiteValues;

    private static ArrayList<Cell> sickValues;

    private int[][] whitePoints = { { 1000, 400 }, { 900, 700 }, { 400, 400 } };

    private ArrayList<Point> redPoints = new ArrayList<>();

    private int[][] sickPoints = { { 100, 300 }, { 500, 100 }, { 300, 600 } };
    ...
    public static ArrayList<Cell> getRedValues()
    {
        return redValues;
    }
    public static ArrayList<Cell> getWhiteValues()
    {
        return whiteValues;
    }
    public static ArrayList<Cell> getSickValues()
    {
        return sickValues;
    }
    ...
    {
        return Cellx >= xOffset && Cellx <= xOffset + World.WIDTH * World.SCALE && Celly >= yOffset
            && Celly <= yOffset + World.HEIGHT * World.SCALE;
    }
